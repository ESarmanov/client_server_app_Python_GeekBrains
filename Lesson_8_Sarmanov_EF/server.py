...
from lib.variables import MAX_CONNECTIONS, PRESENCE, ACTION, TIME, USER, ACCOUNT_NAME, RESPONSE, ERROR, ALERT, AUTH, \
    MSG, ERR200, ERR400, SERVER_TIMEOUT, ENCODING, PACKAGE_LENGTH, LISTEN, SENDER, MSG_TEXT, RESPONSE_200, \
    RESPONSE_400, DESTINATION, EXIT, WHO
...
def client_message_handler(message, messages_list, client, clients, names):
    ...
    if ACTION not in message:
        ...
        send_message(client, {RESPONSE: 400, ERROR: ERR400})
        return
    elif ACTION in message and message[ACTION] == PRESENCE and TIME in message and message[USER][ACCOUNT_NAME] == 'Guest':
